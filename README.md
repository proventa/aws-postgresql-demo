...
```
cd existing_repo
git remote add origin https://gitlab.proventa.io/postgresql/fcos-postgresql-demo/aws-postgresql-demo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.proventa.io/postgresql/fcos-postgresql-demo/aws-postgresql-demo/-/settings/integrations)
